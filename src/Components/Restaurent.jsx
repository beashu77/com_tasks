...
const Restaurent = () => {
    ...
    const [currCusion,setCurrCusion] =useState({})
    const {id} =useParams()
    ...
    const cuisineData = [
     ...
     useEffect(()=>{
       ...
       let currData = (restaurantsData.filter((elem)=>elem.cuisine_id == id))
       

       let currCusion = (cuisineData.filter((elem)=>elem.id == id))
       setData(currData)
       setCurrCusion(currCusion)
       console.log(currData,currCusion)
     },[])
  ...
  return (
    <div>
        ...
        <div>
            <h1>{currCusion[0] && currCusion[0].name}</h1>
            ...
            {data && data.map((elem)=>{
                return <div>
                   ...
                   <p>averageRating :{elem.averageRating}</p>
                </div>
            })}
        </div>
        <hr />
